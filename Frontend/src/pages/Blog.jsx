      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {comments.map((item, index) => (
              <div
                className="relative border max-w-xl 
              p-4 rounded-lg text-gray-300"
                key={index}
              >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <button
              className="text-white border border-gray-300 rounded-lg 
            p-2 px-8 hover:scale-110 transition-all cursor-pointer"
              type="submit"
            >
              Submit
            </button>
