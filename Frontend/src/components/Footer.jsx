...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:x-24 xl:px-32">
      ...
      >
        <div>
          <div className="font-bold text-2xl w-32 sm:w-44 cursor-pointer">
            Ink.AI
          </div>
          <p className="max-w-[410px] mt-6">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt
            ipsum ipsa in corporis cupiditate impedit nisi, quos maiores. Enim
            ipsa totam molestiae earum, voluptatem deleniti!
          </p>
        </div>
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-400">
        CopyRight 2025 , Ink.AI - All Right Reserved
      </p>
    </div>
  );
};
